        ...
        <>
            <div className='w-full flex flex-col gap-2 py-4 border-b-2 dark:border-lightContent'>
                <div className='w-full flex gap-y-3 mb-2 flex-col md:flex-row justify-between md:items-center'>
                    <input ref={job} defaultValue={"Your job"} type='text' className='text-darkContent outline-none border-none focus:border focus:ring-0 focus:border-lightContent p-0 m-0  bg-transparent dark:text-lightContent text-md' />
                    <input ref={type} type='text' defaultValue={" Type employment"} className='outline-none focus:ring-0 bg-buttonSuccess text-buttonText rounded-full font-semibold border-none p-0 m-0 h-fit dark:text-lightContent text-md' />
                </div>
                <div className='w-full flex gap-y-2 flex-col md:flex-row justify-between'>
                    <div className='flex md:gap-x-10'>
                        <div className='flex gap-1'>
                            ...
                            <input type='text' defaultValue={"Company name"} ref={company} className='text-darkContent focus:ring-0 border-none outline-none p-0 m-0 w-fit h-fit bg-transparent dark:text-lightContent text-md' />
                        </div>
                        {<div className='flex gap-1'>
                            <svg
