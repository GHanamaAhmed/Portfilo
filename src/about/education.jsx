...
import { editEducation,deletEducation } from "../redux/aboutReducer";
export default memo(function Education({ specialization, adress, school, location, dateBegin, dateEnd, type, id }) {
    ...
    const deleteWorkExperience = async (e) => {
        e.preventDefault()
        dispatch(deletEducation({id})).unwrap().catch(err=>console.error(err))
    }
    const editeWorkExperience = async (e) => {
        ...
        dispatch(editEducation({ id, education })).unwrap().then(res=> hideEdite()).catch(err=>console.error(err))
    }
...
export function LoadingEducation() {
    return (
        <div className='w-full animate-pulse flex flex-col gap-2 py-4 border-b-2 dark:border-lightContent' >
            <div className='w-full flex gap-y-3 mb-2 flex-col md:flex-row justify-between md:items-center'>
                ...
                <div className='flex md:gap-x-10'>
                    <div className='flex items-center md:gap-x-10'>
                        <div className='flex items-center gap-1'>
                            ...
                            <div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-24 md:w-32 mb-2"></div>
                        </div>
                        <svg
                            className='h-6 w-6 fill-none stroke-lightContent dark:stroke-darkContent'
                            xmlns="http://www.w3.org/2000/svg"
